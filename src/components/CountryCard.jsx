import { Link } from 'react-router-dom';
   ...
   export default function CountryCard({ country }) {
     return (
       <div className="bg-white dark:bg-gray-800 shadow-2xl rounded-2xl p-6 border border-[#740938]/20 dark:border-[#a0114e]/20 hover:shadow-[0_10px_20px_rgba(116,9,56,0.3)] transition-all duration-500 transform hover:scale-105 hover:rotate-1 animate-slideUpBounce">
         ...
         <Link to={`/country/${country.name.common}`} className="text-[#740938] dark:text-[#a0114e] font-bold mt-4 inline-block hover:text-[#4e0625] dark:hover:text-[#740938] transition-all duration-300 hover:scale-110 hover:rotate-2 transform">View Details</Link>
       </div>
     );
   }